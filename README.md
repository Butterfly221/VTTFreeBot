...
### Что я НЕ делаю (намеренно)

- ❌ Не храню аудиофайлы пользователей
- ❌ Не храню тексты расшифровок
- ❌ Не отправляю данные во внешние API
- ❌ Не веду историю запросов
- ❌ Не логирую содержимое
...
Каждый модуль покрывается тестами до подключения следующего.
